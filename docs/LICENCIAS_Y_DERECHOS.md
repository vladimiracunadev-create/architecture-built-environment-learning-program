...
El repositorio separa código, contenido, datos, activos y material de terceros.

| Superficie | Régimen |
|---|---|
| Scripts, workflows, configuraciones y código del sitio | [Apache License 2.0](../LICENSE) |
| Clases, documentación, ejercicios, rutas y material pedagógico original | [CC BY-NC-SA 4.0](../LICENSE-CONTENT.md) |
| Catálogos y registros editoriales | [Licencias de datos](../DATA_LICENSES.md) |
