...
- [Catálogo HTML de las 680 clases](catalogo.html): páginas rápidas, enlazables e imprimibles.
- [Lector offline v1.0](lector-offline-v1.0.html): aplicación monolítica autosuficiente con búsqueda, filtros y progreso local.

## PDF

- [Clases ARQ-661–680](Arquitectura_20_Clases_Finales_v1.0.pdf).
- [ARQ-680 · clase completa](ARQ-680_Clase_Completa_v1.0.pdf).
