# ARQ-658 · Realidad virtual y modelos inmersivos
...
¿Qué puede evaluar un entorno inmersivo sobre experiencia espacial y qué aspectos físicos permanecen fuera del modelo?

## Resultado de aprendizaje y continuidad

Prepararás escenarios VR con escala y estados declarados, estudiarás distancias y campo visual, y distinguirás percepción representada de esfuerzo, sonido, luz o seguridad reales. Esta clase continúa la progresión de la parte y deja explícito qué información debe pasar a la siguiente sin transformar una hipótesis en dato confirmado.
...
VR-01 coloca el ojo virtual a 1,65 m y un cartel de 0,30 m de alto a 12 m de distancia. El ángulo visual aproximado es 2 arctan(0,15/12) ≈ 1,43°. Cambiar el FOV del visor no aumenta físicamente el tamaño del cartel; cambia la presentación. El ejercicio permite comparar configuraciones, no certificar legibilidad de un sistema real.
...
Un objeto de 0,5 m se observa a 10 m. Calcula su ángulo visual aproximado usando 2 arctan(0,25/10). Explica dos límites de esa medida.

## Solución razonada

El ángulo es ≈2,86°. No incorpora resolución del visor, contraste, movimiento, agudeza visual, iluminación real ni comprensión del mensaje. Es una medida geométrica de una condición virtual.
...
Puedes avanzar cuando reconstruyes el caso sin mirar la respuesta, distingues al menos una conclusión válida y una que excedería la evidencia, y señalas qué dato o especialista resolvería la incertidumbre. ARQ-659 continúa el bloque.
