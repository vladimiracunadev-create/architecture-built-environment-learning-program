# ARQ-653 · Maqueta estructural conceptual
...
¿Cómo usar una maqueta para comprender camino de cargas sin interpretar su deformación como predicción directa del edificio?

## Resultado de aprendizaje y continuidad

Construirás modelos de barras y apoyos para visualizar estabilidad, pero distinguirás semejanza geométrica de semejanza material y mecánica. Esta clase continúa la progresión de la parte y deja explícito qué información debe pasar a la siguiente sin transformar una hipótesis en dato confirmado.
...
MOD-EST-01 reduce una cercha de 20 m a 1:100: longitud 200 mm. Si todas las dimensiones lineales se reducen 100 veces, áreas se reducen 10.000 veces y volúmenes un millón de veces. El peso propio relativo y la rigidez no mantienen automáticamente las mismas proporciones porque el material de maqueta y su módulo elástico también cambian. Por eso una deformación visible sirve para investigar comportamiento cualitativo, no para escalar flechas directamente.
...
Una viga de 12 m se modela a 1:60. Calcula su longitud. Explica por qué medir una flecha de 4 mm en el modelo y multiplicarla por 60 no basta para predecir la flecha real.

## Solución razonada

La longitud es 200 mm. Multiplicar la flecha por 60 ignora cambios de sección, módulo elástico, carga, peso propio, conexiones y semejanza mecánica. El modelo puede revelar tendencias, no una predicción directa sin leyes de similitud.
...
Puedes avanzar cuando reconstruyes el caso sin mirar la respuesta, distingues al menos una conclusión válida y una que excedería la evidencia, y señalas qué dato o especialista resolvería la incertidumbre. ARQ-654 continúa el bloque.
