# ARQ-654 · Maqueta de detalle y ensamblaje
...
¿Cómo puede una maqueta de detalle investigar el orden de capas y montaje sin convertirse en un detalle constructivo ejecutable?

## Resultado de aprendizaje y continuidad

Representarás encuentros a gran escala, distinguirás función y secuencia, y documentarás qué espesores son fieles y cuáles simbólicos. Esta clase continúa la progresión de la parte y deja explícito qué información debe pasar a la siguiente sin transformar una hipótesis en dato confirmado.
...
DET-MOD-01 representa a 1:5 una fachada con acabado de 20 mm, cámara de 40, aislación de 100 y soporte de 140. En la maqueta serían 4, 8, 20 y 28 mm: espesor total 60 mm. Si se agrega una membrana real de 1 mm, a escala serían 0,2 mm, probablemente difícil de fabricar; se puede representar simbólicamente si se declara su función y posición.
...
A escala 1:10, representa capas de 15, 50, 80 y 120 mm. Calcula espesores de maqueta y explica cómo representarías una película de 0,5 mm.

## Solución razonada

Las capas son 1,5; 5; 8 y 12 mm. La película sería 0,05 mm, difícil de construir físicamente; puede usarse una lámina simbólica o código gráfico, claramente identificado y sin alterar el espesor total como si fuese exacto.
...
Puedes avanzar cuando reconstruyes el caso sin mirar la respuesta, distingues al menos una conclusión válida y una que excedería la evidencia, y señalas qué dato o especialista resolvería la incertidumbre. ARQ-655 continúa el bloque.
