# ARQ-643 · Liceos y educación media
...
¿Cómo puede un liceo sostener enseñanza general, especialidades, trabajo colaborativo y vida adolescente sin rigidizar el edificio alrededor de un horario único?

## Resultado de aprendizaje y continuidad

Analizarás aulas, talleres, laboratorios, espacios sociales y cambios de horario. Construirás una matriz de simultaneidad y reconocerás cuándo compartir un recinto crea un conflicto operativo. Esta clase continúa la progresión de la parte y deja explícito qué información debe pasar a la siguiente sin transformar una hipótesis en dato confirmado.
...
LIC-01 tiene 12 cursos y cuatro talleres especializados. Dos talleres pueden atender un curso cada uno por bloque. Si seis cursos necesitan taller simultáneamente en una franja horaria, la capacidad instantánea es cuatro y existe un déficit de dos cursos. La solución no es necesariamente construir dos talleres: puede estudiarse horario, duración, equipamiento, compatibilidad o ampliación, pero cada alternativa cambia otra condición.
...
Un liceo tiene tres laboratorios y ocho cursos que requieren una sesión semanal. Si una tarde concentra cinco sesiones simultáneas, identifica el déficit instantáneo y plantea dos estrategias no constructivas que deberían verificarse antes de ampliar.

## Solución razonada

El déficit instantáneo es de dos laboratorios en esa franja. Reprogramar horarios o compartir equipamiento compatible son hipótesis posibles; deben comprobarse currículo, tiempos de preparación, seguridad, capacidad y disponibilidad docente.
...
Puedes avanzar cuando reconstruyes el caso sin mirar la respuesta, distingues al menos una conclusión válida y una que excedería la evidencia, y señalas qué dato o especialista resolvería la incertidumbre. ARQ-644 continúa el bloque.
